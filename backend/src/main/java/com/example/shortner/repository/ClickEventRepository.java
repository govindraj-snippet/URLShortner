...
public interface ClickEventRepository extends JpaRepository<ClickEvent, Long> {
    ...
    // For "Today's Clicks"
    List<ClickEvent> findByUrlMappingUserAndClickDateBetween(User user, LocalDateTime startDate, LocalDateTime endDate);

    // For "Recent Activity"
    List<ClickEvent> findByUrlMappingUserOrderByClickDateDesc(User user);
}
